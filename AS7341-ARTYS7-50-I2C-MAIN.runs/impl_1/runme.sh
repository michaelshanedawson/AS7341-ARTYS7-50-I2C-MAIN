...
HD_PWD='C:/Users/cloud/OneDrive/_Arty_Spartan_7/Projects/AS7341-ARTYS7-50-I2C-MAIN/AS7341-ARTYS7-50-I2C-MAIN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AS7341_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AS7341_wrapper.tcl -notrace
