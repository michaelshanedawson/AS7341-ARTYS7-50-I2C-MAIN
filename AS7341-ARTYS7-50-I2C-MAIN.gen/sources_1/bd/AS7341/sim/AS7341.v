...
//Date        : Mon Apr  8 12:26:43 2024
//Host        : DarkStar running 64-bit major release  (build 9200)
//Command     : generate_target AS7341.bd
//Design      : AS7341
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "AS7341,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=AS7341,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_board_cnt=1,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "AS7341.hwdef" *) 
module AS7341
   (ck_io26_tri_i,
    ck_io26_tri_o,
    ck_io26_tri_t,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLK_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLK_I, CLK_DOMAIN AS7341_sys_clk_i, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clk_i;
  ...
  assign axi_gpio_0_GPIO_TRI_I = ck_io26_tri_i[0];
  ...
  assign ck_io26_tri_o[0] = axi_gpio_0_GPIO_TRI_O;
  assign ck_io26_tri_t[0] = axi_gpio_0_GPIO_TRI_T;
  ...
  AS7341_axi_gpio_0_0 axi_gpio_0
  ...
  AS7341_axi_quad_spi_0_0 axi_quad_spi_0
  ...
  AS7341_axi_uartlite_0_0 axi_uartlite_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > AS7341 microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  AS7341_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_G5SRAA microblaze_0_local_memory
  ...
  AS7341_mig_7series_0_0 mig_7series_0
       (.aresetn(rst_mig_7series_0_81M_peripheral_aresetn),
  ...
  AS7341_rst_clk_wiz_0_100M_0 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
  ...
  AS7341_rst_mig_7series_0_81M_0 rst_mig_7series_0_81M
       (.aux_reset_in(1'b1),
  ...
  AS7341_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
endmodule

module microblaze_0_local_memory_imp_G5SRAA
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > AS7341 microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  AS7341_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  AS7341_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  AS7341_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
